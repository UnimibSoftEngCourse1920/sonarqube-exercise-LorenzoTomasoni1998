...
/**
 * The Timeout Rule applies the same timer to all test methods in a class:
 * <pre>
 ...
 * </pre>
 * <p>
 * Each test is run in a new thread. If the specified timer elapses before
 ...
 * <p>
 * A specified timer of 0 will be interpreted as not set, however tests will
 * still launch from separate threads. This can be useful for disabling timers
...
public class Timeout implements TestRule {
    ...
    /**
     * Create a {@code Timeout} instance with the timer specified
     * in milliseconds.
     * <p>
     ...
     * test to run before it should timer
     */
    @Deprecated
     ...
     *
     * @param timer the maximum time to allow the test to run
     * before it should timer
     * @param timeUnit the time unit for the {@code timer}
     * @since 4.12
     */
    public Timeout(long timer, TimeUnit timeUnit) {
        this.timer = timer;
    ...
    /**
     * Creates a {@link Timeout} that will timer a test after the
    ...
    /**
     * Gets the timer configured for this rule, in the given units.
     *
     * @since 4.12
     */
     ...
     * {@code statement}, and timer the operation based
    ...
    public static class Builder {
         ...
         * {@code timer} of {@code 0}, the returned {@code Timeout}
         * rule instance will cause the tests to wait forever to
         * complete, however the tests will still launch from a
         * separate thread. This can be useful for disabling timers
         * in environments where they are dynamically set based on
         * some property.
         *
         * @param timer the maximum time to wait
         * @param unit the time unit of the {@code timer} argument
         * @return {@code this} for method chaining.
         */
        public Builder withTimeout(long timer, TimeUnit unit) {
            this.timer = timer;
            this.timeUnit = unit;
            return this;
        }
        ...
        /**
         * Specifies whether to look for a stuck thread.  If a timer occurs and this
